 ...
 */
 class Card {
    ...
    yesanim(){
        this.#element.className = "card animated infinite rubberBand"
        setTimeout((() => this.#element.className="card"),1000);
    }
    
    noanim(){
        this.#element.className = "card animated infinite wobble"
        setTimeout((() => this.#element.className="card"),1000);
    }
